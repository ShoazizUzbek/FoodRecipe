 ...
 */
public class LatestMenu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_latest_menu, container, false);
        progressBar = view.findViewById(R.id.progress_latest);
    ...
    private void loadMenu() {
        ...
        Call<Example> call = apiInterface.searchRecipe("28ecb84c6a07f38af498f383d6a0bc2d","chicken%20breast","2");
